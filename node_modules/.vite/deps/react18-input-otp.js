...
var require_lib = __commonJS({
  "node_modules/react18-input-otp/lib/index.js"(exports) {
    Object.defineProperty(exports, "__esModule", { value: true });
    exports["default"] = void 0;
    var _react = _interopRequireWildcard(require_react());
    var _excluded = ["placeholder", "separator", "isLastChild", "ariaLabelOverride", "shouldRender", "inputStyle", "focus", "isDisabled", "hasErrored", "errorStyle", "isSuccessed", "successStyle", "focusStyle", "disabledStyle", "shouldAutoFocus", "isInputNum", "index", "value", "className", "isInputSecure", "onSubmit"];
    ...
    var OtpInput = function(_Component) {
      ...
      function OtpInput2() {
        ...
        _defineProperty(_assertThisInitialized(_this2), "handleOnInput", function(e) {
          ...
          if (e.target.value && e.target.value.length > 1) {
            ...
            e.clipboardData = { getData: function getData() {
              return value.trim();
            } };
        ...
        _defineProperty(_assertThisInitialized(_this2), "renderInputs", function() {
          ...
          var _loop = function _loop2(i2) {
            ...
            if ((i2 + 1) % parseInt(separateAfter) === 0) {
              shouldRender = true;
            } else {
              shouldRender = false;
            }
            var testAttr = {};
            if (customTestAttr) {
              testAttr[customTestAttr] = customTestId && "".concat(customTestId, "-").concat(i2);
            }
            var currentInputProps = {};
            if (inputProps) {
              if (Array.isArray(inputProps)) {
                if (inputProps[i2]) {
                  currentInputProps = inputProps[i2];
                }
              } else {
                currentInputProps = inputProps;
              }
            }
            inputs.push(_react["default"].createElement(SingleOtpInput, _extends({ id: id && "".concat(id, "-").concat(i2), autoComplete: autoComplete !== null && autoComplete !== void 0 ? autoComplete : "off", placeholder: placeholder && placeholder[i2], key: i2, index: i2, focus: activeInput === i2, value: otp && otp[i2], onChange: _this2.handleOnChange, onKeyDown: _this2.handleOnKeyDown, onInput: _this2.handleOnInput, onPaste: _this2.handleOnPaste, onFocus: function onFocus(e) {
              _this2.setState({ activeInput: i2 });
              e.target.select();
            }, onBlur: function onBlur() {
              return _this2.setState({ activeInput: -1 });
            }, separator, inputStyle, focusStyle, isLastChild: i2 === numInputs - 1, isDisabled, disabledStyle, hasErrored, errorStyle, isSuccessed, successStyle, shouldAutoFocus, isInputNum, isInputSecure, className, "data-cy": dataCy && "".concat(dataCy, "-").concat(i2), "data-testid": dataTestId && "".concat(dataTestId, "-").concat(i2), shouldRender, onSubmit }, currentInputProps, testAttr)));
          };
      ...
      _createClass(OtpInput2, [{ key: "componentDidUpdate", value: function componentDidUpdate() {
    ...
    }, isDisabled: false, shouldAutoFocus: false, value: "", isInputSecure: false, onSubmit: function onSubmit(otp) {
      return console.log(otp);
    } });
...
//# sourceMappingURL=react18-input-otp.js.map
